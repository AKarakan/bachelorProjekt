...
insert into tester values (null,"Abdu", 'karakan', 'pass', '51103', 'Steinmetzstraße 25', 'abdu.karakan@googlemail.com','0221 123123' ,'https://i.pravatar.cc/400?img=68', '{"Needs": [""]}','{"Asys": ["High Contrast"]}','OnSite', ST_GeomFromText('POINT(50.94284477264888 7.007675625622846)'));
insert into tester values (null,"Abdu", 'karakan', 'pass', '51103', 'Steinmetzstraße 25', 'abdu.karakan2@googlemail.com','0221 123124' ,'https://i.pravatar.cc/400?img=68', '{"Needs": [""]}','{"Asys": ["High Contrast", "Brailezeile", "Screen Reader"]}','Hybrid', ST_GeomFromText('POINT(50.94284477264888 7.007675625622846)'));
